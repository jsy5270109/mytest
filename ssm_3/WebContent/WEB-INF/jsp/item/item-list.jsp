...
<body> 
<form name="itemForm" action="${pageContext.request.contextPath }/queryItem.do" method="post">
查询条件：
...
<td><input type="checkbox" name="itemId" value="${item.id}" /></td>
	...
	<td><a href="${pageContext.request.contextPath }/user/showItemEdit.do?itemid=${item.id}">修改</a></td>
